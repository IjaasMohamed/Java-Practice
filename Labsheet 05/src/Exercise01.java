...
class Dog extends Animal {
    ...
    public Dog() {             System.out.println("Dog constructor called");      }
...
class Cat extends Animal {
    public Cat() {             System.out.println("Cat constructor called");      }
...
class ToyCat extends Cat {
    ...
    public ToyCat() {             System.out.println("ToyCat constructor called");      }
